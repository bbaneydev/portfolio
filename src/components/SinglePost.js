            ...
            <article className='container shadow-lg mx-auto bg-gray-100 rounded-lg'>
                <header className='relative'>
                    <div className='absolute h-full w-full flex items-center justify-center p-8'>
                        <div className='bg-w bg-opacity-75 rounded p-12'>
                            <div className='container bg-gray-400 opacity-90 rounded p-12'>
                            <h1 className='cursive text-3xl text-black-600 lg:text-6xl mb-4'>{singlePost.title}</h1>
                ...
                <div className='px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full'>
                    <BlockContent blocks={singlePost.body} projectId='w79szajx' dataset='production'/>
                </div>
            </article>
        </main>
    )
